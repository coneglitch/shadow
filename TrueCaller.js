const findUrl = (reg) => reg.test($request.url);
const features = [
    { id: "premium_caller_id", rank: 1, status: "Included", "isFree": false },
    { id: "no_ads", rank: 2, status: "Included", "isFree": false },
    { id: "premium_badge", rank: 3, status: "Included", "isFree": false },
    { id: "spam_blocking", rank: 4, status: "Included", "isFree": true },
    { id: "incognito_mode", rank: 5, status: "Included", "isFree": false },
    { id: "caller_id", rank: 6, status: "Included", "isFree": true },
    { id: "extended_spam_blocking", rank: 7, status: "Included", "isFree": false },
    { id: "announce_call", rank: 8, status: "Included", "isFree": false },
    { id: "live_chat_support", rank: 9, status: "Included", "isFree": false },
    { id: "live_caller_id", rank: 10, status: "Included", "isFree": false },
    { id: "call_recording", rank: 11, status: "Included", "isFree": false },
    { id: "offline_caller_id", rank: 12, status: "Included", "isFree": false },
    { id: "contact_request", rank: 13, status: "Included", "isFree": false },
    { id: "premium_support", rank: 14, status: "Included", "isFree": false },
